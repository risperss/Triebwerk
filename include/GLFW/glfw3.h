 ...
 *  @ref glfwgetMousePointerButton returns `GLFW_PRESS` the next time it is
 ...
 *  @ingroup input
 */
GLFWAPI int glfwgetMousePointerButton(GLFWwindow* window, int button);
 ...
 *
 *  @since Added in version 3.0.  Replaces `glfwgetMousePointerPos`.
 *
 *  @ingroup input
 */
